...
const Wtf: NextPage = () => {
    return (
        <div className={styles.mainContainer}>
            <h2>What is this?</h2>
            <br /><h3>PUCKFACE Hockey is an App in Beta testing which allows users to collect digital hockey trading cards which can be used to play against other puckface users with.</h3>
